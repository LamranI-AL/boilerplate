  ...
  return (
    <div>
      {isSuperAdmin ? (
        ...
        >
          ...
          <div className="mt-4 text-xs font-medium ">
            ...
            <p className="mt-2 text-gray-500">
              Toutes les actions effectuées sont enregistrées avec les dates et
              les noms des personnes les ayant effectuées. Veuillez utiliser ces
        ...
        <div className="relative block m-24 overflow-hidden rounded-lg border border-gray-100 p-4 sm">
          <span className="absolute inset-x-0 bottom-0 h-2 bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"></span>
